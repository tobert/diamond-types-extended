...
mod test {
    ...
    fn eq_smoke_test() {
        ...
        a.get_or_create_agent_id(Uuid::from_u128(0x341CE));
        ...
        b.get_or_create_agent_id(Uuid::from_u128(0x5E98));
        ...
        c.get_or_create_agent_id(Uuid::from_u128(0x5E98));
        c.get_or_create_agent_id(Uuid::from_u128(0x341CE));
